...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(
    ...
    final double toolbarOpacity = !pinned || isPinnedWithOpacityFade
        ...
        : 1.0;
    appBarStateChangeController
        ?.setValue((max(minExtent, maxExtent - shrinkOffset) == minExtent));
...
class _FloatingAppBar extends StatefulWidget {
  ...
  @override
  FloatingAppBarState createState() => FloatingAppBarState();
}

// A wrapper for the widget created by _SliverAppBarDelegate that starts and
// stops the floating app bar's snap-into-view or snap-out-of-view animation.
class FloatingAppBarState extends State<_FloatingAppBar> {
...
class AppBarStateChangeController extends ChangeNotifier {
  ...
  void setValue(bool verticalOffset) {
