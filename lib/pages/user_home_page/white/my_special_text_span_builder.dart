...
class MySpecialTextSpanBuilder extends SpecialTextSpanBuilder {
  ...
  SpecialText? createSpecialText(String flag,
    ...
    if (isStart(flag, AtText.flag)) {
      ...
      return ImageText(textStyle!, context,
          start: index - (ImageText.flag.length - 1), onClick: onTap);
    } else if (isStart(flag, GoodsText.flag)) {
      return GoodsText(textStyle!,
          start: index - (GoodsText.flag.length - 1),
          onGoodsTap: goodsCardOnTapCallBack);
