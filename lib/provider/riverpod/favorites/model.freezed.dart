...
MyFavoritesModel _$MyFavoritesModelFromJson(Map<String, dynamic> json) {
  return _MyFavoritesModel.fromJson(json);
}
...
abstract class _MyFavoritesModel implements MyFavoritesModel {
