...
/// Adds pattern-matching-related methods to [ApplocationContext].
extension ApplocationContextPatterns on ApplocationContext {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ApplocationContext value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApplocationContext() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(BuildContext context, WidgetRef ref)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ApplocationContext() when $default != null:
        return $default(_that.context, _that.ref);
      case _:
        return orElse();
    }
  }
...
extension ApplicationModelPatterns on ApplicationModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ApplicationModel() when $default != null:
        return $default(_that.context, _that.ref, _that.favoritesRepository,
            _that.applocationContext);
      case _:
        return orElse();
    }
  }
