...
final routers = GoRouter(
  routes: [
    ...
    GoRoute(path: pagerUtil.resourceWrite.routername,builder: (context, state) {
      return MyResourceWritePage(params: state.extra as DynWriteParams);
    },),
    GoRoute(
      path: pagerUtil.resourceList.routername,builder: (context, state) {
      return MyResourcePage(params: state.extra as DynPageParams);
    },),
    GoRoute(path: pagerUtil.meetList.routername,builder: (context, state) {
