...
class ZheElmResultModel with _$ZheElmResultModel {
  ...
  const factory ZheElmResultModel({
      @JsonKey(name: 'alibabaAlscUnionElemePromotionOfficialactivityGetResponse') @Default(Alibabaalscunionelemepromotionofficialactivitygetresponse())  Alibabaalscunionelemepromotionofficialactivitygetresponse alibabaalscunionelemepromotionofficialactivitygetresponse,
    }) = _ZheElmResultModel;
  
  factory ZheElmResultModel.fromJson(Map<String, dynamic> json) => _$ZheElmResultModelFromJson(json);

}


@freezed
class Alibabaalscunionelemepromotionofficialactivitygetresponse with _$Alibabaalscunionelemepromotionofficialactivitygetresponse {
  ...
  factory Alibabaalscunionelemepromotionofficialactivitygetresponse.fromJson(Map<String, dynamic> json) => _$AlibabaalscunionelemepromotionofficialactivitygetresponseFromJson(json);
