...
@JsonKey(name: 'content') IList<dynamic> get content;@JsonKey(name: 'empty') bool get empty;@JsonKey(name: 'first') bool get first;@JsonKey(name: 'last') bool get last;@JsonKey(name: 'number') int get number;@JsonKey(name: 'numberOfElements') int get numberOfElements;@JsonKey(name: 'pageable') Pageable get pageable;@JsonKey(name: 'size') int get size;@JsonKey(name: 'sort') Sort get sort;@JsonKey(name: 'totalElements') int get totalElements;@JsonKey(name: 'totalPages') int get totalpages;
/// Create a copy of JpaPage
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$JpaPageCopyWith<JpaPage> get copyWith => _$JpaPageCopyWithImpl<JpaPage>(this as JpaPage, _$identity);
...
abstract mixin class $JpaPageCopyWith<$Res>  {
  factory $JpaPageCopyWith(JpaPage value, $Res Function(JpaPage) _then) = _$JpaPageCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: 'content') IList<dynamic> content,@JsonKey(name: 'empty') bool empty,@JsonKey(name: 'first') bool first,@JsonKey(name: 'last') bool last,@JsonKey(name: 'number') int number,@JsonKey(name: 'numberOfElements') int numberOfElements,@JsonKey(name: 'pageable') Pageable pageable,@JsonKey(name: 'size') int size,@JsonKey(name: 'sort') Sort sort,@JsonKey(name: 'totalElements') int totalElements,@JsonKey(name: 'totalPages') int totalpages
});


$PageableCopyWith<$Res> get pageable;$SortCopyWith<$Res> get sort;

}
/// @nodoc
class _$JpaPageCopyWithImpl<$Res>
...
/// Create a copy of JpaPage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? content = null,Object? empty = null,Object? first = null,Object? last = null,Object? number = null,Object? numberOfElements = null,Object? pageable = null,Object? size = null,Object? sort = null,Object? totalElements = null,Object? totalpages = null,}) {
  return _then(_self.copyWith(
content: null == content ? _self.content : content // ignore: cast_nullable_to_non_nullable
as IList<dynamic>,empty: null == empty ? _self.empty : empty // ignore: cast_nullable_to_non_nullable
...
as int,pageable: null == pageable ? _self.pageable : pageable // ignore: cast_nullable_to_non_nullable
as Pageable,size: null == size ? _self.size : size // ignore: cast_nullable_to_non_nullable
as int,sort: null == sort ? _self.sort : sort // ignore: cast_nullable_to_non_nullable
as Sort,totalElements: null == totalElements ? _self.totalElements : totalElements // ignore: cast_nullable_to_non_nullable
...
class _JpaPage extends JpaPage {
  const _JpaPage({@JsonKey(name: 'content') this.content = const IListConst([]), @JsonKey(name: 'empty') this.empty = false, @JsonKey(name: 'first') this.first = false, @JsonKey(name: 'last') this.last = false, @JsonKey(name: 'number') this.number = 0, @JsonKey(name: 'numberOfElements') this.numberOfElements = 0, @JsonKey(name: 'pageable') this.pageable = const Pageable(), @JsonKey(name: 'size') this.size = 0, @JsonKey(name: 'sort') this.sort = const Sort(), @JsonKey(name: 'totalElements') this.totalElements = 0, @JsonKey(name: 'totalPages') this.totalpages = 0}): super._();
  factory _JpaPage.fromJson(Map<String, dynamic> json) => _$JpaPageFromJson(json);

@override@JsonKey(name: 'content') final  IList<dynamic> content;
...
@pragma('vm:prefer-inline')
_$JpaPageCopyWith<_JpaPage> get copyWith => __$JpaPageCopyWithImpl<_JpaPage>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$JpaPageToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _JpaPage&&const DeepCollectionEquality().equals(other.content, content)&&(identical(other.empty, empty) || other.empty == empty)&&(identical(other.first, first) || other.first == first)&&(identical(other.last, last) || other.last == last)&&(identical(other.number, number) || other.number == number)&&(identical(other.numberOfElements, numberOfElements) || other.numberOfElements == numberOfElements)&&(identical(other.pageable, pageable) || other.pageable == pageable)&&(identical(other.size, size) || other.size == size)&&(identical(other.sort, sort) || other.sort == sort)&&(identical(other.totalElements, totalElements) || other.totalElements == totalElements)&&(identical(other.totalpages, totalpages) || other.totalpages == totalpages));
}
...
abstract mixin class _$JpaPageCopyWith<$Res> implements $JpaPageCopyWith<$Res> {
  factory _$JpaPageCopyWith(_JpaPage value, $Res Function(_JpaPage) _then) = __$JpaPageCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'content') IList<dynamic> content,@JsonKey(name: 'empty') bool empty,@JsonKey(name: 'first') bool first,@JsonKey(name: 'last') bool last,@JsonKey(name: 'number') int number,@JsonKey(name: 'numberOfElements') int numberOfElements,@JsonKey(name: 'pageable') Pageable pageable,@JsonKey(name: 'size') int size,@JsonKey(name: 'sort') Sort sort,@JsonKey(name: 'totalElements') int totalElements,@JsonKey(name: 'totalPages') int totalpages
});
...
@override $PageableCopyWith<$Res> get pageable;@override $SortCopyWith<$Res> get sort;

}
/// @nodoc
class __$JpaPageCopyWithImpl<$Res>
    implements _$JpaPageCopyWith<$Res> {
...
/// Create a copy of JpaPage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? content = null,Object? empty = null,Object? first = null,Object? last = null,Object? number = null,Object? numberOfElements = null,Object? pageable = null,Object? size = null,Object? sort = null,Object? totalElements = null,Object? totalpages = null,}) {
...
@JsonKey(name: 'offset') int get offset;@JsonKey(name: 'pageNumber') int get pageNumber;@JsonKey(name: 'pageSize') int get pageSize;@JsonKey(name: 'paged') bool get paged;@JsonKey(name: 'sort') Sort get sort;@JsonKey(name: 'unpaged') bool get unpaged;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,offset,pageNumber,pageSize,paged,sort,unpaged);
...
@useResult
$Res call({
@JsonKey(name: 'offset') int offset,@JsonKey(name: 'pageNumber') int pageNumber,@JsonKey(name: 'pageSize') int pageSize,@JsonKey(name: 'paged') bool paged,@JsonKey(name: 'sort') Sort sort,@JsonKey(name: 'unpaged') bool unpaged
});
...
/// Create a copy of Pageable
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? offset = null,Object? pageNumber = null,Object? pageSize = null,Object? paged = null,Object? sort = null,Object? unpaged = null,}) {
  return _then(_self.copyWith(
...
as Sort,unpaged: null == unpaged ? _self.unpaged : unpaged // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of Pageable
...
class _Pageable extends Pageable {
  const _Pageable({@JsonKey(name: 'offset') this.offset = 0, @JsonKey(name: 'pageNumber') this.pageNumber = 0, @JsonKey(name: 'pageSize') this.pageSize = 0, @JsonKey(name: 'paged') this.paged = false, @JsonKey(name: 'sort') this.sort = const Sort(), @JsonKey(name: 'unpaged') this.unpaged = false}): super._();
...
/// Create a copy of Pageable
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? offset = null,Object? pageNumber = null,Object? pageSize = null,Object? paged = null,Object? sort = null,Object? unpaged = null,}) {
...
class _Sort extends Sort {
  const _Sort({@JsonKey(name: 'empty') this.empty = false, @JsonKey(name: 'sorted') this.sorted = false, @JsonKey(name: 'unsorted') this.unsorted = false}): super._();
