...
@JsonKey(name: 'absolutePath') String get absolutePath;@JsonKey(name: 'collect') bool get collect;@JsonKey(name: 'createDate') String get createDate;@JsonKey(name: 'fileName') String get fileName;@JsonKey(name: 'fileSize') int get fileSize;@JsonKey(name: 'fileType') String get fileType;@JsonKey(name: 'height') int get height;@JsonKey(name: 'id') int get id;@JsonKey(name: 'intro') String get intro;@JsonKey(name: 'tagColor') String get tagColor;@JsonKey(name: 'updateDate') String get updateDate;@JsonKey(name: 'url') String get url;@JsonKey(name: 'width') int get width;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,absolutePath,collect,createDate,fileName,fileSize,fileType,height,id,intro,tagColor,updateDate,url,width);
...
@useResult
$Res call({
@JsonKey(name: 'absolutePath') String absolutePath,@JsonKey(name: 'collect') bool collect,@JsonKey(name: 'createDate') String createDate,@JsonKey(name: 'fileName') String fileName,@JsonKey(name: 'fileSize') int fileSize,@JsonKey(name: 'fileType') String fileType,@JsonKey(name: 'height') int height,@JsonKey(name: 'id') int id,@JsonKey(name: 'intro') String intro,@JsonKey(name: 'tagColor') String tagColor,@JsonKey(name: 'updateDate') String updateDate,@JsonKey(name: 'url') String url,@JsonKey(name: 'width') int width
});
...
/// Create a copy of FileInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? absolutePath = null,Object? collect = null,Object? createDate = null,Object? fileName = null,Object? fileSize = null,Object? fileType = null,Object? height = null,Object? id = null,Object? intro = null,Object? tagColor = null,Object? updateDate = null,Object? url = null,Object? width = null,}) {
  return _then(_self.copyWith(
absolutePath: null == absolutePath ? _self.absolutePath : absolutePath // ignore: cast_nullable_to_non_nullable
as String,collect: null == collect ? _self.collect : collect // ignore: cast_nullable_to_non_nullable
...
class _FileInfo extends FileInfo {
  const _FileInfo({@JsonKey(name: 'absolutePath') this.absolutePath = '', @JsonKey(name: 'collect') this.collect = false, @JsonKey(name: 'createDate') this.createDate = '', @JsonKey(name: 'fileName') this.fileName = '', @JsonKey(name: 'fileSize') this.fileSize = 0, @JsonKey(name: 'fileType') this.fileType = '', @JsonKey(name: 'height') this.height = 0, @JsonKey(name: 'id') this.id = 0, @JsonKey(name: 'intro') this.intro = '', @JsonKey(name: 'tagColor') this.tagColor = '', @JsonKey(name: 'updateDate') this.updateDate = '', @JsonKey(name: 'url') this.url = '', @JsonKey(name: 'width') this.width = 0}): super._();
  factory _FileInfo.fromJson(Map<String, dynamic> json) => _$FileInfoFromJson(json);

@override@JsonKey(name: 'absolutePath') final  String absolutePath;
@override@JsonKey(name: 'collect') final  bool collect;
...
@override@JsonKey(name: 'tagColor') final  String tagColor;
...
/// Create a copy of FileInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? absolutePath = null,Object? collect = null,Object? createDate = null,Object? fileName = null,Object? fileSize = null,Object? fileType = null,Object? height = null,Object? id = null,Object? intro = null,Object? tagColor = null,Object? updateDate = null,Object? url = null,Object? width = null,}) {
