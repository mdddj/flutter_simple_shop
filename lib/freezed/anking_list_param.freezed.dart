...
/// Adds pattern-matching-related methods to [AnkingListParam].
extension AnkingListParamPatterns on AnkingListParam {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AnkingListParam value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AnkingListParam() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: 'rank') String rank,
    ...
    switch (_that) {
      case _AnkingListParam() when $default != null:
        return $default(_that.rank, _that.cid);
      case _:
        return orElse();
    }
  }
