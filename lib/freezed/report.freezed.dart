...
mixin _$AddReportParams {
  ...
  $AddReportParamsCopyWith<AddReportParams> get copyWith =>
      _$AddReportParamsCopyWithImpl<AddReportParams>(
          this as AddReportParams, _$identity);
...
abstract mixin class $AddReportParamsCopyWith<$Res> {
  factory $AddReportParamsCopyWith(
          AddReportParams value, $Res Function(AddReportParams) _then) =
      _$AddReportParamsCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: 'content') String content,
      @JsonKey(name: 'type') String type});
...
/// Adds pattern-matching-related methods to [AddReportParams].
extension AddReportParamsPatterns on AddReportParams {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AddReportParams value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AddReportParams() when $default != null:
        return $default(_that);
      case _:
        return orElse();
    }
...
class _AddReportParams extends AddReportParams {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AddReportParamsCopyWith<_AddReportParams> get copyWith =>
      __$AddReportParamsCopyWithImpl<_AddReportParams>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AddReportParamsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AddReportParamsCopyWith<$Res>
    implements $AddReportParamsCopyWith<$Res> {
  factory _$AddReportParamsCopyWith(
          _AddReportParams value, $Res Function(_AddReportParams) _then) =
      __$AddReportParamsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'content') String content,
