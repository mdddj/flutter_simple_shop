...
/// Adds pattern-matching-related methods to [SimpleResult].
extension SimpleResultPatterns on SimpleResult {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SimpleResult value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SimpleResult() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _SimpleResult() when $default != null:
        return $default(
            _that.message, _that.state, _that.success, _that.type, _that.data);
      case _:
        return orElse();
    }
  }
