...
mixin _$Comment {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.childCommentWithData, childCommentWithData) &&
            (identical(other.createDate, createDate) ||
                other.createDate == createDate) &&
            (identical(other.user, user) || other.user == user) &&
            const DeepCollectionEquality().equals(other.likeusers, likeusers) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      parentComment,
      type,
      const DeepCollectionEquality().hash(childCommentWithData),
      createDate,
      user,
      const DeepCollectionEquality().hash(likeusers),
...
extension CommentPatterns on Comment {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            ...
            @JsonKey(name: 'type') String type,
            @JsonKey(name: 'childCommentWithData')
            List<Comment> childCommentWithData,
            @JsonKey(name: 'createDate') String createDate,
            @JsonKey(name: 'user') MyUser user,
            @JsonKey(name: 'likeUsers') List<MyUser> likeusers,
            @JsonKey(name: 'childComment') List<Comment> childComment)?
